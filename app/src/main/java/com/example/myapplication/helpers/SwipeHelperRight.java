...
public abstract class SwipeHelperRight extends ItemTouchHelper.SimpleCallback {
    ...
    public SwipeHelperRight(Context context, RecyclerView recyclerView, String rightOrLeft) {

        super(0, rightOrLeft.equals("right") ? ItemTouchHelper.RIGHT : ItemTouchHelper.LEFT);
    ...
    public static class UnderlayButton {
        ...
        public boolean onClick(float x, float y) {
            ...
            System.out.println(clickRegion.contains(x,y));
            return false;
        }
